...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 16, backgroundColor: theme.primary, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, marginBottom: 8 },
  title: { ...typography.title, writingDirection: 'rtl', textAlign: 'right', color: '#FFFFFF' },
  subtitle: { ...typography.caption, writingDirection: 'rtl', textAlign: 'right', marginTop: 2, color: 'rgba(255,255,255,0.7)' },
  adminBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: theme.radiusFull },
  ...
  heroCard: { marginHorizontal: 16, backgroundColor: theme.primary, borderRadius: theme.radiusXL, padding: 24, marginBottom: 16, alignItems: 'center', borderWidth: 0, ...theme.shadowElevated },
  heroValue: { fontSize: 42, fontWeight: '700', color: theme.accent },
  heroLabel: { fontSize: 13, fontWeight: '500', color: 'rgba(255,255,255,0.75)', marginTop: 4, writingDirection: 'rtl' },
  heroDivider: { height: 1, width: '100%', backgroundColor: 'rgba(255,255,255,0.2)', marginVertical: 16 },
  ...
  heroSubLabel: { fontSize: 12, color: 'rgba(255,255,255,0.65)', writingDirection: 'rtl' },
  heroSubValue: { fontSize: 13, fontWeight: '700', color: '#FFFFFF' },
